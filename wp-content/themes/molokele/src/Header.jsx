...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-transparent text-brand-blue font-sans shadow-none">
      {/* Primary Header Row Wrapper */}
      <div className="w-full bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-24 items-center justify-between">
            
            {/* Brand Logo / M.P. Title (Left blank for now) */}
            <div className="flex flex-shrink-0 flex-col h-16 w-48">
              {/* Blank */}
            </div>
      ...
      <div className="absolute top-full left-0 w-full bg-transparent z-10 overflow-hidden md:overflow-visible">
        {/* Background layer spanning to the right edge of screen */}
        <div className="molokele-contact-bg" />
        
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-20">
          <div className="flex justify-end">
            <div className="w-full md:w-auto py-4 pl-4 pr-4 md:pl-16 md:pr-0 flex flex-col md:flex-row items-center justify-between gap-6 text-white">
              {/* Contact Info Text */}
              <div className="text-xs sm:text-sm font-sans tracking-wide text-center md:text-left flex flex-wrap items-center justify-center md:justify-start gap-1.5">
              ...
              <div className="flex items-center gap-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex h-8 w-8 items-center justify-center rounded-full border-2 border-brand-pink text-white hover:bg-brand-pink transition-colors duration-200"
                  aria-label="Facebook"
                >
